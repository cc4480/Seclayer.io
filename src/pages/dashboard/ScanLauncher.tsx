...
import { Play, Globe, AlertTriangle, ArrowRight } from 'lucide-react';

interface ScanLauncherProps {
  // scanUrl is lifted to Dashboard because the PentAGI panel reads it too.
  scanUrl: string;
...
/** Quick scan launcher form with optional authenticated-scan header field. */
export default function ScanLauncher({ scanUrl, setScanUrl, credits, isPerformingAction, onInitiateScan }: ScanLauncherProps) {
