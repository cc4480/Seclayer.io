...
interface FindingSuppressionPanelProps {
  finding: Finding;
...
/**
 * False Positives Management UI drawer toggle: shows either the
 * suppression-justification input form, the "exempted risk" banner for an
 * already-suppressed finding, or the "Mark False Positive" trigger button.
 */
export default function FindingSuppressionPanel({
  finding,
  suppressInputId,
  suppressReason,
  isSuppressing,
      ...
      {suppressInputId === finding.id ? (
        <div className="bg-[#121214] border border-[#27272a]/80 p-3.5 rounded space-y-3 animate-fade-in">
          ...
          <input
            ...
            onChange={(e) => onSuppressReasonChange(e.target.value)}
          ...
          <div className="flex justify-end space-x-2">
            ...
            <button
              onClick={() => onSaveSuppression(finding)}
        ...
        <div className="flex justify-between items-center">
          {finding.isFalsePositive ? (
            <div className="flex items-center justify-between w-full bg-zinc-900/40 border border-dashed border-zinc-800/80 px-3.5 py-2 rounded">
              ...
              <button
                disabled={isSuppressing}
                onClick={() => onRemoveSuppressionDirectly(finding.title)}
            ...
            <>
              ...
              <button
                onClick={() => onOpenSuppressInput(finding.id)}
