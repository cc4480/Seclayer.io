    ...
    <div className="min-h-screen bg-[#09090b] text-[#a1a1aa] selection:bg-[#22c55e]/30 selection:text-[#22c55e]">
      ...
      <div className="relative py-24 px-6 overflow-hidden border-b border-[#27272a] bg-[radial-gradient(120%_120%_at_50%_0%,rgba(34,197,94,0.05)_0%,rgba(9,9,11,0)_80%)]">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 flex flex-col items-center">
          ...
          >
            A black-box penetration testing platform. Submit a URL and receive a plain-English AI-generated penetration testing report.
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6">
            ...
            <p className="text-[#a1a1aa] text-xs font-mono mb-8 leading-relaxed">
              The Seclayer Model Context Protocol (MCP) server brings automated security testing into developer environments. Simply provide your API Key and query live vulnerabilities in natural language.
            </p>
      ...
      <footer className="border-t border-[#27272a] bg-[#0c0c0e] py-12 text-[#a1a1aa] text-xs font-mono text-center">
        <div className="max-w-7xl mx-auto px-6 space-y-4">
          <p className="text-[11px]">Domain: <strong className="text-white">seclayer.io</strong> • Stack: React + Express 5 + SQLite + Gemini AI</p>
