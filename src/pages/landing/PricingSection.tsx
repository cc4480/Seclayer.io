...
// Pay-per-scan pricing cards. Each button forwards its pack id to onSelectPack.
export default function PricingSection({ onSelectPack }: { onSelectPack: (packName: Pack) => void }) {
  return (
