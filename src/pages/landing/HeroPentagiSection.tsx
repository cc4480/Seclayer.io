...
import PentagiDemoConsole from './PentagiDemoConsole.js';

interface HeroPentagiSectionProps {
  onStartTrial: (initialUrl: string) => void;
  userEmail: string;
}

export default function HeroPentagiSection({ onStartTrial, userEmail }: HeroPentagiSectionProps) {
  ...
  return (
    <div className="relative py-24 px-6 overflow-hidden border-b border-[#27272a] bg-[radial-gradient(120%_120%_at_50%_0%,rgba(34,197,94,0.05)_0%,rgba(9,9,11,0)_80%)]">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 flex flex-col items-center">
        ...
        <PentagiDemoConsole onStartTrial={onStartTrial} userEmail={userEmail} />
