...
interface McpIntegrationTabsProps {
  onNavigate: (view: string, arg?: string) => void;
}

/** MCP server pitch with a tabbed terminal showing per-editor setup snippets. */
export default function McpIntegrationTabs({ onNavigate }: McpIntegrationTabsProps) {
