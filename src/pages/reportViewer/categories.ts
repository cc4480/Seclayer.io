...
// The AppSec pillar tabs, in display order, with their icon + long-form term.
...
export function getCategorySeverity(findings: Finding[], cat: SecCategory): string {
...
export function scoreColorClass(score: number): string {
  ...
  return isLowRisk ? 'text-[#22c55e] border-[#22c55e]/25 bg-[#22c55e]/5' :
