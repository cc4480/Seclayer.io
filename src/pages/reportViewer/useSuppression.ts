...
// Owns the false-positive suppression workflow: opening the justification input,
// saving a suppression rule, and removing an existing one. Extracted so the
// ReportViewer view and the finding cards stay small.
...
export type SuppressionState = ReturnType<typeof useSuppression>;
