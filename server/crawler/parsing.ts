// Pure HTML parsing + injectable-target extraction for the crawler. No
// network I/O, so these are trivially unit-testable in isolation.
...
export function stripFragment(u: string): string {
  const i = u.indexOf("#");
